    ...
    <div>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-6 py-12 text-center">
          ...
          <h2 className="text-3xl font-extrabold text-white mb-2">Unlock Premium</h2>
          <p className="text-gray-400 text-[15px] max-w-[400px] mx-auto">
          ...
          >
            ...
            <ul className="space-y-2 mb-4">
              {plan.features.map((feature, i) => (
                <li key={i} className="flex items-center gap-2 text-[15px] text-gray-300">
      ...
      <div className="px-4 pb-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <div key={i} className="p-4 rounded-xl border border-gray-800/50 bg-gray-900/30">
              <span className="text-2xl">{feature.icon}</span>
              <h4 className="font-bold text-white text-sm mt-2">{feature.title}</h4>
