  ...
  return (
    <div>
      ...
      <div className={`px-4 pb-4 border-b ${tc.border}`}>
        <div className="flex items-end justify-between -mt-16 mb-3">
          ...
          <div className="flex gap-2 mt-12">
            ...
            <button
              ...
              className={`px-5 py-1.5 rounded-full font-bold text-[15px] transition-colors ${tc.bgTertiary} ${tc.text} ${tc.bgHoverSecondary}`}
            >
              Edit profile
            </button>
          </div>
        ...
        <p className={`text-[15px] ${tc.text} mt-3 leading-relaxed`}>{user.bio}</p>
      ...
      {showEditModal && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-16">
          ...
          <div className={`relative w-full max-w-[600px] mx-4 ${tc.bgModal} rounded-2xl border ${tc.border} shadow-2xl p-4`}>
            <div className="flex items-center justify-between mb-4">
              <button onClick={() => setShowEditModal(false)} className={`p-2 rounded-full transition-colors ${tc.bgHoverSecondary}`}>
